...
const PAIRWISE_RULES: readonly PairwiseInterpretationRule[] = [
  ...
  { key: 'style_driver_analyst', domainKey: 'signal_style', primarySignalKey: 'style_driver', secondarySignalKey: 'style_analyst', summary: 'Moves quickly toward outcomes and tends to set direction early, while still relying on logic and structure to keep decisions clear, defensible, and well grounded.', supportingLine: 'This pattern is often effective when action matters but the reasoning also needs to hold up under pressure or scrutiny.', tensionClause: 'It can become limiting when urgency cuts short reflection, or when precision slows decisions that need a firmer call.' },
  ...
  { key: 'style_influencer_analyst', domainKey: 'signal_style', primarySignalKey: 'style_influencer', secondarySignalKey: 'style_analyst', summary: 'An expressive, people-facing style supported by clear thinking and structure. Tends to communicate ideas with energy while still wanting the logic to hold up under scrutiny.' },
  { key: 'style_operator_driver', domainKey: 'signal_style', primarySignalKey: 'style_operator', secondarySignalKey: 'style_driver', summary: 'A dependable, execution-led style with a decisive edge. Tends to value consistency and follow-through, but will raise the pace quickly when outcomes or accountability are at stake.' },
  ...
  { key: 'lead_results_vision', domainKey: 'signal_lead', primarySignalKey: 'lead_results', secondarySignalKey: 'lead_vision', summary: 'Sets a strong line on outcomes while giving people a clear sense of where the work is heading and why it matters. Direction tends to feel purposeful as well as demanding, with pace anchored to a visible future state.', supportingLine: 'This often lands well when people need both sharper accountability and a reason to stretch beyond the immediate task.', tensionClause: 'The balance can slip if vision outruns follow-through, or if delivery pressure starts to crowd out reflection and commitment.' },
  { key: 'lead_results_people', domainKey: 'signal_lead', primarySignalKey: 'lead_results', secondarySignalKey: 'lead_people', summary: 'Leadership tends to be performance-led, but not purely hard-edged. Outcomes come first, while support and trust still matter enough to keep people engaged behind the standard.' },
  ...
  { key: 'lead_vision_results', domainKey: 'signal_lead', primarySignalKey: 'lead_vision', secondarySignalKey: 'lead_results', summary: 'Leadership tends to create momentum by connecting people to a compelling direction, then tightening toward delivery. The future picture matters, but it is still expected to turn into visible outcomes.' },
  { key: 'lead_vision_people', domainKey: 'signal_lead', primarySignalKey: 'lead_vision', secondarySignalKey: 'lead_people', summary: 'Leadership tends to bring people along through belief, encouragement, and a sense of shared direction. The emphasis is on momentum with meaning, not just pressure or instruction.' },
  ...
  { key: 'lead_people_vision', domainKey: 'signal_lead', primarySignalKey: 'lead_people', secondarySignalKey: 'lead_vision', summary: 'Leadership tends to bring people with the work through support, encouragement, and a positive sense of direction. Connection matters first, though momentum still needs a clear destination.' },
  ...
  { key: 'conflict_collaborate_accommodate', domainKey: 'signal_conflict', primarySignalKey: 'conflict_collaborate', secondarySignalKey: 'conflict_accommodate', summary: 'Usually stays in disagreement with a genuine effort to keep the relationship intact and the tone constructive. The pattern often sounds measured, engaged, and considerate, which can help difficult conversations remain workable rather than defensive.', supportingLine: 'This is often useful when the issue matters but trust, inclusion, and future cooperation matter as well.', tensionClause: 'It can lose strength if protecting the relationship makes the challenge too soft, particularly when clearer boundaries or firmer challenge would improve the outcome.' },
  ...
  { key: 'conflict_accommodate_collaborate', domainKey: 'signal_conflict', primarySignalKey: 'conflict_accommodate', secondarySignalKey: 'conflict_collaborate', summary: 'Tends to protect the relationship while still trying to keep the conversation open enough for a shared answer to emerge. The pattern often shows up as careful listening, reduced heat, and a real effort to help the other person stay in the discussion.', supportingLine: 'This can be especially useful where trust is fragile and the disagreement still needs to be worked through rather than quietly absorbed.', tensionClause: 'It becomes limiting when preserving calm starts to outweigh stating the harder truth clearly, because others may leave feeling comfortable without being fully aligned.' },
  { key: 'conflict_accommodate_compromise', domainKey: 'signal_conflict', primarySignalKey: 'conflict_accommodate', secondarySignalKey: 'conflict_compromise', summary: 'Tends to reduce tension by adapting to others or finding middle ground early, which can help conversations stay constructive and preserve working relationships. The trade-off is that important differences may be softened too quickly when clearer challenge would lead to a better outcome.' },
  ...
  { key: 'conflict_avoid_compete', domainKey: 'signal_conflict', primarySignalKey: 'conflict_avoid', secondarySignalKey: 'conflict_compete', summary: 'May step back from disagreement at first, but can switch into a much firmer response once the issue feels costly enough that avoiding it is no longer workable. This often makes the pattern look cautious on entry and unexpectedly direct once the threshold for action has been crossed.', supportingLine: 'The delay usually reflects an attempt to avoid unnecessary heat, not an unlimited willingness to leave the issue unresolved.', tensionClause: 'It can become difficult for others to read if concerns stay quiet for too long and then surface with more force than the moment requires.' },
  ...
  { key: 'stress_control_avoidance', domainKey: 'signal_stress', primarySignalKey: 'stress_control', secondarySignalKey: 'stress_avoidance', summary: 'Under pressure, there is often an immediate push to regain control, restore order, and keep things moving, even while the hardest unresolved tension becomes less comfortable to face directly. This can make the response look decisive around visible tasks but more avoidant around the conversation that feels most charged.', supportingLine: 'The pattern often helps briefly by containing noise and creating structure when the situation feels loose or risky.', tensionClause: 'It becomes limiting when control is used to manage around the problem rather than through it, because the visible work may keep moving while the real tension stays untouched.' },
  { key: 'stress_control_criticality', domainKey: 'signal_stress', primarySignalKey: 'stress_control', secondarySignalKey: 'stress_criticality', summary: 'Stress is likely to increase the need for control, accuracy, and firmer judgement, which can help bring order back into a difficult situation. As pressure keeps building, the response often becomes more exacting, more fault-sensitive, and less tolerant of looseness in others.', supportingLine: 'This pattern can be useful in the early stages of strain when standards need tightening and ambiguity needs reducing quickly.', tensionClause: 'If overextended, perspective narrows and others may contribute less freely because the environment starts feeling harder, tighter, and more heavily judged.' },
  ...
  { key: 'stress_avoidance_criticality', domainKey: 'signal_stress', primarySignalKey: 'stress_avoidance', secondarySignalKey: 'stress_criticality', summary: 'When pressure rises, difficult issues may be delayed outwardly even while inner standards become sharper and more exacting. This can make the pattern look calm or contained from the outside, while the internal response is becoming more tense, critical, and less forgiving.', supportingLine: 'The early benefit is often reduced visible escalation, especially when a more immediate confrontation would only add heat.', tensionClause: 'It becomes limiting when the harder judgement stays mostly internal, because concerns are neither released cleanly nor addressed directly while the strain continues to build.' },
...
function buildSupportLine(
  ...
  const rangeLine =
    context.blendProfile === 'balanced' && secondaryTitle
      ? `${secondaryTitle} stays close enough to shape how this area comes through day to day.`
