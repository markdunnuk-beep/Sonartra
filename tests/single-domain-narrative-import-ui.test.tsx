...
test('single-domain narrative builder renders section-first import controls for all six sections', () => {
  ...
  assert.match(markup, /SINGLE_DOMAIN_INTRO/);
  assert.match(markup, /SINGLE_DOMAIN_HERO/);
  assert.match(markup, /SINGLE_DOMAIN_DRIVERS/);
  assert.match(markup, /SINGLE_DOMAIN_PAIR/);
  assert.match(markup, /SINGLE_DOMAIN_LIMITATION/);
  assert.match(markup, /SINGLE_DOMAIN_APPLICATION/);
