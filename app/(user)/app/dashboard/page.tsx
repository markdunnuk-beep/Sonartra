    ...
    <main className="space-y-8">
      <header className="space-y-3">
        ...
        <p className="max-w-3xl text-sm text-white/65">
          Persisted lifecycle state and ready results across your published assessments.
        </p>
      </header>
      ...
      {viewModel.totalAssessments === 0 ? (
        <section className="sonartra-panel space-y-3">
          ...
          <p className="text-sm text-white/65">
            The dashboard is connected to canonical lifecycle and result reads, but no published
