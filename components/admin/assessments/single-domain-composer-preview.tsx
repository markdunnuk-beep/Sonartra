      ...
      {previewState.status === 'empty' ? (
        ...
        <SurfaceCard className="p-0">
          <details className="group">
            <summary className="sonartra-focus-ring flex cursor-pointer list-none flex-wrap items-start justify-between gap-4 rounded-[1rem] px-5 py-4 marker:hidden lg:px-6">
              <div className="space-y-2">
                <p className="sonartra-page-eyebrow">Report preview</p>
                <CardTitle>Preview generated report sections</CardTitle>
                <SecondaryText>
                  Open this when you need to inspect the composed report, diagnostics, and provenance.
                </SecondaryText>
              </div>
              <LabelPill className="border-[rgba(50,214,176,0.18)] bg-[rgba(50,214,176,0.06)] text-[rgba(213,255,245,0.86)]">
                {previewState.report.sections.length} sections
              </LabelPill>
            </summary>
            ...
            <div className="border-t border-white/8 p-5 lg:p-6">
              <div className="grid gap-4 xl:grid-cols-[minmax(0,1.45fr)_minmax(320px,0.8fr)]">
                <div className="space-y-8 rounded-[1rem] border border-white/8 bg-black/10 p-5 lg:p-6">
                ...
                <div className="space-y-4">
                  <details className="rounded-[1rem] border border-white/8 bg-black/10">
                    <summary className="sonartra-focus-ring flex cursor-pointer list-none items-center justify-between gap-3 rounded-[1rem] px-4 py-3 marker:hidden">
                      <span className="text-sm font-medium text-white">Diagnostics and provenance</span>
                      <LabelPill
                        className={cn(
                          previewState.diagnostics.hasBlockingIssues
                            ? 'border-[rgba(255,157,157,0.2)] bg-[rgba(80,20,20,0.18)] text-[rgba(255,216,216,0.94)]'
                      ...
                      >
                        {previewState.diagnostics.hasBlockingIssues ? 'Attention' : 'Ready'}
                      </LabelPill>
                    </summary>
